...
WiimotePluginDialog4Winows::WiimotePluginDialog4Winows() : dialog(NULL)
{
}

WiimotePluginDialog4Winows::~WiimotePluginDialog4Winows()
{
}


void WiimotePluginDialog4Winows::close()
{
	setVisible(false);
...
void WiimotePluginDialog4Winows::setVisible(bool v)
{
	if (v)
	{
